...
class CsvModule:
    ...
    def option3(self):
        ...
        data = pd.read_csv('Modules\\csv\\starships.csv')

        # Seleccionar las columnas relevantes
        columns_of_interest = ['hyperdrive_rating', 'MGLT', 'max_atmosphering_speed', 'cost_in_credits']
        df = data[columns_of_interest]

        # Convertir las columnas a numéricas, ignorando errores en caso de que haya valores faltantes o no numéricos
